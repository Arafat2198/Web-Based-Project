<?php
   ...
   $query = "SELECT usn,name,class,branch,semester,password from student where status='0';";
   ...
   if (mysqli_num_rows($result1)>0)
   {
     ...
     if(isset($_POST['submit']))
     {
         ...
         if(!empty($_POST['usn']))
         {
             ...
             {
                 $query1 = "UPDATE student set status='1' where usn='$value';";
                 mysqli_query($link, $query1);
             }
             echo "Selected Accounts have been Approved !!";
             header("location:http://localhost/project/Front_End/dashboard/Admin%20Dashboard/student/Authenticate/Authenication_student.php");
         }
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><strong>Student Account Approval  List</strong></h1>
      ...
      <div class="table-responsive">
        ...
        ?>
        <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure you want to Authenticate the user?')" name="submit">Approve</button>
      </form>
      </div>
    </main>
  </div>
