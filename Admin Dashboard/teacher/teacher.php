<?php
 ...
 <main role="main">
   ...
   <section class="jumbotron text-center">
     <div class="container">
       <h1 class="jumbotron-heading"><strong>Faculty Administrator</strong></h1>
       <p>
       ...
       <div class="row">
         <div class="col-md-4">
           <div class="card mb-4 shadow-sm">
             ...
             <div class="card-body">
               <p class="card-text"><strong>Authenticate Accounts</strong></p>
               <div class="d-flex justify-content-between align-items-center">
                 <div class="btn-group">
                   <button type="button" class="btn btn-sm btn-outline-secondary"> <a href="http://localhost/project/Front_End/dashboard/Admin%20Dashboard/teacher/Authenticate/Authenication_teacher.php" > View</a></button>
                 </div>
               </div>
             </div>
           </div>
         ...
         <div class="col-md-4">
           <div class="card mb-4 shadow-sm">
             ...
             <div class="card-body">
               ...
               <div class="d-flex justify-content-between align-items-center">
                 <div class="btn-group">
                   <button type="button" class="btn btn-sm btn-outline-secondary"> <a href="http://localhost/project/Front_End/dashboard/Admin%20Dashboard/teacher/Block_Remove/Remove_Block_teacher.php" >View</a></button>
                 </div>
         ...
         <div class="col-md-4">
           <div class="card mb-4 shadow-sm">
             ...
             <div class="card-body">
               ...
               <div class="d-flex justify-content-between align-items-center">
                 <div class="btn-group">
                   <button type="button" class="btn btn-sm btn-outline-secondary"><a href="http://localhost/project/Front_End/dashboard/Admin%20Dashboard/teacher/Update_info/Teacher_Details_Update_1.php">View</a></button>
                 </div>
                 <small class="text-muted"></small>
               </div>
             </div>
