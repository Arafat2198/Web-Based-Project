<?php
   ...
   $query = "SELECT empid,name,post,branch,email,password from teacher where status='1';";
   ...
   if (mysqli_num_rows($result1)>0)
   {
     ...
     if(isset($_POST['submit1']))
     {
         ...
         if(!empty($_POST['empid']))
         {
             ...
             {
                 $query1 = "UPDATE teacher set status='0' where empid='$value';";
                 mysqli_query($link, $query1);
             }
             echo "Selected Accounts have been Blocked !!";
             header("location:http://localhost/project/Front_End/dashboard/Admin%20Dashboard/teacher/Block_Remove/Remove_Block_teacher.php");
         }
         else
         {
     ...
     if(isset($_POST['submit2']))
     {
         ...
         if(!empty($_POST['empid']))
         {
             ...
             foreach($_POST['empid'] as $value)
             {
                 $query2 = "DELETE from teacher where empid='$value';";
  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2"><strong>Approved Faculty Accounts</strong></h1>
      ...
      <div class="table-responsive">
        <table id='table1' class="table table-striped ">
          <thead  class="thead-light">
            <tr>
              ...
              <th>Branch</th>
              <th>Email</th>
              <th style="text-align: center;">Block / Delete</th>
              <br>
            </tr>
          </thead>
          <tbody>
        ...
        <div class="text-center">
          <button type="submit" class="btn btn-warning btn-lg " name="submit1">Block Account</button>&nbsp&nbsp&nbsp
          <button type="submit" class="btn btn-danger btn-lg " name="submit2">Delete Account</button>
        </div>
       </form>
      </div>
    </main>
